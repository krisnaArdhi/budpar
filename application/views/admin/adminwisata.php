                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <input class="au-input au-input--xl" type="text" name="search_text" id="search_text" placeholder="Cari Nama Wisata" />
                      ...
                      <div class="row">
                          <div class="col-md-12">
                              <div class="overview-wrap">
                                  <h2 class="title-1">Daftar Wisata</h2>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" action="<?php echo base_url();?>admin/tambah_wisata">
              <div class="card">
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo base_url(); ?>admin/fetch_wisata",
   method:"POST",
   data:{query:query},
